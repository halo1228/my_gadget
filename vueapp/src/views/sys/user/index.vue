    ...
    <div class="app-container">
        <el-container>
            ...
            <el-main>
                <el-form ref="paramsForm" :model="params" :inline="true" class="demo-form-inline" label-suffix="："
                    ...
                    <el-form-item style="float: right">
                        <el-button :size="size" icon="el-icon-plus" @click="formDrawer.visible=true" type="primary">
                            添加
                        </el-button>
                    </el-form-item>
                </el-form>
            ...
            <DrawerForm ref="drawerForm" :formVisible="formDrawer.visible"
                        :title="formDrawer.editFormId===''?'添加' :'编辑'" size="50%"
                        @closeFormDrawer="closeFormDrawer">
                <template v-slot:content>
                    <Add v-if="formDrawer.editFormId===''" ref="add" @refreshData="loadData"></Add>
                    <Edit v-else ref="edit" :editFormId="formDrawer.editFormId"
                          @refreshData="loadData"></Edit>
                </template>
            </DrawerForm>
        </el-container>
    </div>
...
import Add from "@/views/sys/user/add.vue";
...
export default {
    name: "User",
    components: {DrawerForm, Edit, Tree, Add},
    data() {
        return {
            formDrawer: {//抽屉相关属性
